...
class perNOut extends StatefulWidget {
  @override
  _perNOutState createState() => _perNOutState();
}

class _perNOutState extends State<perNOut> {
...
//Let associate be a model class with attributes name,gender and age and associateList be a list of associate model class.
    ...
    await Firestore.instance.collection("NightOutRequest").where('company', isEqualTo: userCompany).where('comment', isEqualTo: 'Approved').orderBy('timestamp', descending: true).getDocuments():
    truckNo != 'all' && month == 'all' ?
    await Firestore.instance.collection("NightOutRequest").where('comment', isEqualTo: 'Approved').where('company', isEqualTo: userCompany).where('Truck', isEqualTo: truckNo).orderBy('timestamp', descending: true).getDocuments():
    truckNo == 'all' && month != 'all' ?
    await Firestore.instance.collection("NightOutRequest").where('comment', isEqualTo: 'Approved').where('company', isEqualTo: userCompany).where('month', isEqualTo: month).orderBy('timestamp', descending: true).getDocuments():
    truckNo != 'all' && month != 'all' ?
    await Firestore.instance.collection("NightOutRequest").where('comment', isEqualTo: 'Approved').where('company', isEqualTo: userCompany).where('Truck', isEqualTo: truckNo).where('month', isEqualTo: month).orderBy('timestamp', descending: true).getDocuments():
    await Firestore.instance.collection("NightOutRequest").where('comment', isEqualTo: 'Approved').where('company', isEqualTo: userCompany).orderBy('timestamp', descending: true).getDocuments();
